...
static void LoadCreditsMonPic(u8 whichMon)
{
    ...
    case CREDITSMON_CHARIZARD:
        ...
        LoadMonPicInWindow(SPECIES_CALICE, SHINY_ODDS, 0, TRUE, 10, 0);
    ...
    case CREDITSMON_VENUSAUR:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_CSANAE, SHINY_ODDS, 0, TRUE, 10, 0);
    ...
    case CREDITSMON_BLASTOISE:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_CREISEN, SHINY_ODDS, 0, TRUE, 10, 0);
    ...
    case CREDITSMON_PIKACHU:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_CREIMU, SHINY_ODDS, 0, TRUE, 10, 0);
...
static u16 GetCreditsMonSpecies(u8 whichMon)
{
    ...
    {
    case CREDITSMON_CHARIZARD:
        return SPECIES_CALICE;
    case CREDITSMON_VENUSAUR:
        return SPECIES_CSANAE;
    case CREDITSMON_BLASTOISE:
        return SPECIES_CREISEN;
    case CREDITSMON_PIKACHU:
        return SPECIES_CREIMU;
    default:
        return SPECIES_NONE;
    }
}

...
const u8 gText_PokedexTableOfContents[] = _("iDollDex  Table Of Contents");
...
const u8 gText_PokemonHabitats[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}Puppet Habitats");
const u8 gText_DexCategory_GrasslandPkmn[] = _("Grassland Puppets");
const u8 gText_DexCategory_ForestPkmn[] = _("Forest Puppets");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("Water's-edge Puppets");
const u8 gText_DexCategory_SeaPkmn[] = _("Sea Puppets");
const u8 gText_DexCategory_CavePkmn[] = _("Cave Puppets");
const u8 gText_DexCategory_MountainPkmn[] = _("Mountain Puppets");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("Rough-terrain Puppets");
const u8 gText_DexCategory_UrbanPkmn[] = _("Urban Puppets");
const u8 gText_DexCategory_RarePkmn[] = _("Rare Puppets");
...
const u8 gText_ClosePokedex[] = _("Close iDollDex");
const u8 gText_TypeMode[] = _("Type Mode");
const u8 gText_LightestMode[] = _("Cost Mode");
const u8 gText_SmallestMode[] = _("Evolution Mode");
const u8 gText_PokemonList[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}Puppet List");
const u8 gText_NumericalModeKanto[] = _("Numerical Mode: Kanto");
const u8 gText_NumericalModeNational[] = _("Numerical Mode: National");
const u8 gText_PokemonListNoColor[] = _("Puppet List");
...
const u8 gText_PokedexPokemon[] = _(" PUPPET");
const u8 gText_HT[] = _("HT");
const u8 gText_WT[] = _("CT");
...
const u8 gSaveStatName_Pokedex[] = _("iDollDex");
...
const u8 gText_PokeBalls2[] = _("Miko Orbs");
...
const u8 gText_NoMoreThanThreeMayEnter[] = _("No more than three Puppets\nmay enter.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanTwoMayEnter[] = _("No more than two Puppets\nmay enter.{PAUSE_UNTIL_PRESS}");

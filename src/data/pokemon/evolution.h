...
{
    [SPECIES_BULBASAUR]  = {{EVO_LEVEL, 36, SPECIES_IVYSAUR}}, // Sanae
    [SPECIES_VENUSAUR]    = {{EVO_LEVEL, 36, SPECIES_CHARMANDER}}, // Alice
    [SPECIES_CHARMELEON] = {{EVO_LEVEL, 36, SPECIES_CHARIZARD}}, // Reisen
    ...
    [SPECIES_RATTATA]    = {{EVO_LEVEL, 25, SPECIES_RATICATE}}, // Nazrin
    [SPECIES_SPEAROW]    = {{EVO_LEVEL, 25, SPECIES_FEAROW}}, // Tokiko
    [SPECIES_EKANS]      = {{EVO_LEVEL, 22, SPECIES_ARBOK}},
    [SPECIES_PIKACHU]    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU}},
    [SPECIES_SANDSHREW]  = {{EVO_LEVEL, 28, SPECIES_SANDSLASH}, // Rumia
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_URSARING},
                            {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_SLUGMA}},
    ...
    [SPECIES_VULPIX]     = {{EVO_LEVEL, 35, SPECIES_NINETALES}}, // Suika
    ...
    [SPECIES_DIGLETT]    = {{EVO_LEVEL, 28, SPECIES_DUGTRIO}}, // Yamame
    ...
    [SPECIES_MACHOP]     = {{EVO_LEVEL, 38, SPECIES_MACHOKE}}, // Yuugi
    [SPECIES_BELLSPROUT] = {{EVO_LEVEL, 21, SPECIES_WEEPINBELL}},
    [SPECIES_WEEPINBELL] = {{EVO_LEVEL, 28, SPECIES_VICTREEBEL}}, // Parsee
    [SPECIES_TENTACOOL]  = {{EVO_LEVEL, 30, SPECIES_TENTACRUEL}},
    [SPECIES_GEODUDE]    = {{EVO_LEVEL, 23, SPECIES_GRAVELER}}, // Kisume
    ...
    [SPECIES_DODUO]      = {{EVO_LEVEL, 28, SPECIES_DODRIO}}, // Daiyousei
    [SPECIES_SEEL]       = {{EVO_LEVEL, 32, SPECIES_DEWGONG}}, // Nitori
    [SPECIES_GRIMER]     = {{EVO_LEVEL, 28, SPECIES_MUK}}, // Hina
    ...
    [SPECIES_GENGAR]     = {{EVO_LEVEL, 32, SPECIES_ONIX}}, // Meiling
    ...
    [SPECIES_TANGELA]    = {{EVO_LEVEL, 22, SPECIES_KANGASKHAN}}, // Sunny
    [SPECIES_HORSEA]     = {{EVO_LEVEL, 22, SPECIES_SEADRA}}, // Luna
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 22, SPECIES_SEAKING}}, // Star
    [SPECIES_STARYU]     = {{EVO_LEVEL, 35, SPECIES_STARMIE}}, // Yuuka
    [SPECIES_SCYTHER]    = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR}},
    [SPECIES_TAUROS]   = {{EVO_LEVEL, 28, SPECIES_MAGIKARP}}, // Wriggle
    ...
    [SPECIES_UMBREON]     = {{EVO_LEVEL, 28, SPECIES_MURKROW}}, // Kurumi
    ...
    [SPECIES_SHUPPET]    = {{EVO_LEVEL, 25, SPECIES_BANETTE}}, // Kyouko

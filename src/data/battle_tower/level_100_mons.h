...
{
	{
		.species = SPECIES_KEDAMA, //LINOONE,
	...
	{
		.species = SPECIES_KEDAMA, //MIGHTYENA,
	...
	{
		.species = SPECIES_KEDAMA, //BEAUTIFLY,
	...
	{
		.species = SPECIES_KEDAMA, //NUZLEAF,
	...
	{
		.species = SPECIES_KEDAMA, //SWELLOW,
	...
	{
		.species = SPECIES_KEDAMA, //PELIPPER,
	...
	{
		.species = SPECIES_KEDAMA, //BRELOOM,
	...
	{
		.species = SPECIES_KEDAMA, //NINJASK,
		.heldItem = BATTLE_TOWER_ITEM_RAWST_BERRY,
		.teamFlags = 0x41,
		.moves = {
			MOVE_SCRATCH,
	...
	{
		.species = SPECIES_KEDAMA, //NOSEPASS,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x01,
		.moves = {
			MOVE_ROCK_THROW,
	...
	{
		.species = SPECIES_KEDAMA, //DELCATTY,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x42,
		.moves = {
			MOVE_DOUBLE_SLAP,
	...
	{
		.species = SPECIES_KEDAMA, //CAMERUPT,
	...
	{
		.species = SPECIES_KEDAMA, //SANDSLASH,
	...
	{
		.species = SPECIES_KEDAMA, //WHISCASH,
		.heldItem = BATTLE_TOWER_ITEM_CHESTO_BERRY,
		.teamFlags = 0x01,
		.moves = {
			MOVE_TICKLE,
	...
	{
		.species = SPECIES_KEDAMA, //CACTURNE,
	...
	{
		.species = SPECIES_KEDAMA, //JIGGLYPUFF,
	...
	{
		.species = SPECIES_KEDAMA, //MAGNETON,
		.heldItem = BATTLE_TOWER_ITEM_RAWST_BERRY,
		.teamFlags = 0x01,
		.moves = {
			MOVE_THUNDER_SHOCK,
	...
	{
		.species = SPECIES_KEDAMA, //CARVANHA,
		.heldItem = BATTLE_TOWER_ITEM_KINGS_ROCK,
		.teamFlags = 0x01,
		.moves = {
			MOVE_BITE,
	...
	{
		.species = SPECIES_KEDAMA, //KECLEON,
		.heldItem = BATTLE_TOWER_ITEM_PERSIM_BERRY,
		.teamFlags = 0x03,
		.moves = {
			MOVE_THIEF,
	...
	{
		.species = SPECIES_KEDAMA, //NINETALES,
		.heldItem = BATTLE_TOWER_ITEM_CHARCOAL,
		.teamFlags = 0x02,
		.moves = {
			MOVE_EMBER,
	...
	{
		.species = SPECIES_KEDAMA, //GRAVELER,
	...
	{
		.species = SPECIES_KEDAMA, //SHUPPET,
	...
	{
		.species = SPECIES_KEDAMA, //LUVDISC,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x0A,
		.moves = {
			MOVE_ATTRACT,
	...
	{
		.species = SPECIES_KEDAMA, //LANTURN,
	...
	{
		.species = SPECIES_KEDAMA, //CORSOLA,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x0A,
		.moves = {
			MOVE_MIRROR_COAT,
	...
	{
		.species = SPECIES_KEDAMA, //WAILMER,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x05,
		.moves = {
			MOVE_SURF,
	...
	{
		.species = SPECIES_KEDAMA, //GOLDUCK,
	...
	{
		.species = SPECIES_KEDAMA, //BELLOSSOM,
	...
	{
		.species = SPECIES_KEDAMA, //TROPIUS,
		.heldItem = BATTLE_TOWER_ITEM_KINGS_ROCK,
		.teamFlags = 0x05,
		.moves = {
			MOVE_STOMP,
	...
	{
		.species = SPECIES_KEDAMA, //SABLEYE,
		.heldItem = BATTLE_TOWER_ITEM_SPELL_TAG,
		.teamFlags = 0x0A,
		.moves = {
			MOVE_NIGHT_SHADE,
	...
	{
		.species = SPECIES_KEDAMA, //ELECTRODE,
		.heldItem = BATTLE_TOWER_ITEM_FOCUS_BAND,
		.teamFlags = 0x03,
		.moves = {
			MOVE_SONIC_BOOM,
	...
	{
		.species = SPECIES_KEDAMA, //TENTACRUEL,
		.heldItem = BATTLE_TOWER_ITEM_POISON_BARB,
		.teamFlags = 0x01,
		.moves = {
			MOVE_ACID,
	...
	{
		.species = SPECIES_KEDAMA, //CLAYDOL,
		.heldItem = BATTLE_TOWER_ITEM_SOFT_SAND,
		.teamFlags = 0x05,
		.moves = {
			MOVE_ANCIENT_POWER,
	...
	{
		.species = SPECIES_KEDAMA, //GRUMPIG,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x0A,
		.moves = {
			MOVE_PSYBEAM,
	...
	{
		.species = SPECIES_KEDAMA, //CRAWDAUNT,
	...
	{
		.species = SPECIES_KEDAMA, //SEVIPER,
		.heldItem = BATTLE_TOWER_ITEM_POISON_BARB,
		.teamFlags = 0x01,
		.moves = {
			MOVE_POISON_TAIL,
	...
	{
		.species = SPECIES_KEDAMA, //ZANGOOSE,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x05,
		.moves = {
			MOVE_FURY_CUTTER,
	...
	{
		.species = SPECIES_KEDAMA, //ALTARIA,
	...
	{
		.species = SPECIES_KEDAMA, //ROSELIA,
		.heldItem = BATTLE_TOWER_ITEM_CHESTO_BERRY,
		.teamFlags = 0x0A,
		.moves = {
			MOVE_LEECH_SEED,
	...
	{
		.species = SPECIES_KEDAMA, //VOLBEAT,
		.heldItem = BATTLE_TOWER_ITEM_BRIGHT_POWDER,
		.teamFlags = 0x09,
		.moves = {
			MOVE_SIGNAL_BEAM,
	...
	{
		.species = SPECIES_KEDAMA, //ILLUMISE,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x09,
		.moves = {
			MOVE_CHARM,
	...
	{
		.species = SPECIES_KEDAMA, //MANECTRIC,
	...
	{
		.species = SPECIES_KEDAMA, //HARIYAMA,
		.heldItem = BATTLE_TOWER_ITEM_KINGS_ROCK,
		.teamFlags = 0x05,
		.moves = {
			MOVE_ARM_THRUST,
	...
	{
		.species = SPECIES_KEDAMA, //SKARMORY,
		.heldItem = BATTLE_TOWER_ITEM_METAL_COAT,
		.teamFlags = 0x01,
		.moves = {
			MOVE_STEEL_WING,
	...
	{
		.species = SPECIES_KEDAMA, //TORKOAL,
		.heldItem = BATTLE_TOWER_ITEM_PECHA_BERRY,
		.teamFlags = 0x03,
		.moves = {
			MOVE_FIRE_SPIN,
	...
	{
		.species = SPECIES_KEDAMA, //GYARADOS,
		.heldItem = BATTLE_TOWER_ITEM_PERSIM_BERRY,
		.teamFlags = 0x05,
		.moves = {
			MOVE_THRASH,
	...
	{
		.species = SPECIES_KEDAMA, //MASQUERAIN,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x0A,
		.moves = {
			MOVE_TOXIC,
	...
	{
		.species = SPECIES_KEDAMA, //SCEPTILE,
	...
	{
		.species = SPECIES_KEDAMA, //BLAZIKEN,
		.heldItem = BATTLE_TOWER_ITEM_KINGS_ROCK,
		.teamFlags = 0x06,
		.moves = {
			MOVE_DOUBLE_KICK,
	...
	{
		.species = SPECIES_KEDAMA, //SWAMPERT,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x49,
		.moves = {
			MOVE_SURF,
	...
	{
		.species = SPECIES_KEDAMA, //SALAMENCE,
		.heldItem = BATTLE_TOWER_ITEM_DRAGON_FANG,
		.teamFlags = 0x49,
		.moves = {
			MOVE_DRAGON_BREATH,
	...
	{
		.species = SPECIES_KEDAMA, //KINGDRA,
		.heldItem = BATTLE_TOWER_ITEM_PERSIM_BERRY,
		.teamFlags = 0x49,
		.moves = {
			MOVE_SURF,
	...
	{
		.species = SPECIES_KEDAMA, //HERACROSS,
		.heldItem = BATTLE_TOWER_ITEM_KINGS_ROCK,
		.teamFlags = 0x06,
		.moves = {
			MOVE_MEGAHORN,
	...
	{
		.species = SPECIES_KEDAMA, //GIRAFARIG,
		.heldItem = BATTLE_TOWER_ITEM_LUM_BERRY,
		.teamFlags = 0x09,
		.moves = {
			MOVE_PSYCHIC,
	...
	{
		.species = SPECIES_KEDAMA, //VILEPLUME,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x89,
		.moves = {
			MOVE_POISON_POWDER,
	...
	{
		.species = SPECIES_KEDAMA, //MEDICHAM,
	...
	{
		.species = SPECIES_KEDAMA, //DUSCLOPS,
		.heldItem = BATTLE_TOWER_ITEM_SPELL_TAG,
		.teamFlags = 0x4B,
		.moves = {
			MOVE_CONFUSE_RAY,
	...
	{
		.species = SPECIES_KEDAMA, //CASTFORM,
		.heldItem = BATTLE_TOWER_ITEM_LUM_BERRY,
		.teamFlags = 0x82,
		.moves = {
			MOVE_WEATHER_BALL,
	...
	{
		.species = SPECIES_KEDAMA, //MILOTIC,
		.heldItem = BATTLE_TOWER_ITEM_DRAGON_FANG,
		.teamFlags = 0x02,
		.moves = {
			MOVE_SURF,
	...
	{
		.species = SPECIES_KEDAMA, //SHARPEDO,
		.heldItem = BATTLE_TOWER_ITEM_PERSIM_BERRY,
		.teamFlags = 0x01,
		.moves = {
			MOVE_CRUNCH,
	...
	{
		.species = SPECIES_KEDAMA, //TRAPINCH,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x09,
		.moves = {
			MOVE_TOXIC,
	...
	{
		.species = SPECIES_KEDAMA, //LUNATONE,
		.heldItem = BATTLE_TOWER_ITEM_BRIGHT_POWDER,
		.teamFlags = 0x43,
		.moves = {
			MOVE_PSYCHIC,
	...
	{
		.species = SPECIES_KEDAMA, //SOLROCK,
		.heldItem = BATTLE_TOWER_ITEM_PECHA_BERRY,
		.teamFlags = 0x43,
		.moves = {
			MOVE_SOLAR_BEAM,
	...
	{
		.species = SPECIES_KEDAMA, //MAGCARGO,
		.heldItem = BATTLE_TOWER_ITEM_BRIGHT_POWDER,
		.teamFlags = 0x89,
		.moves = {
			MOVE_FLAMETHROWER,
	...
	{
		.species = SPECIES_KEDAMA, //MACHAMP,
	...
	{
		.species = SPECIES_KEDAMA, //LUDICOLO,
		.heldItem = BATTLE_TOWER_ITEM_LUM_BERRY,
		.teamFlags = 0x0C,
		.moves = {
			MOVE_FAKE_OUT,
	...
	{
		.species = SPECIES_KEDAMA, //SHIFTRY,
		.heldItem = BATTLE_TOWER_ITEM_PERSIM_BERRY,
		.teamFlags = 0x0C,
		.moves = {
			MOVE_FRUSTRATION,
	...
	{
		.species = SPECIES_KEDAMA, //GARDEVOIR,
		.heldItem = BATTLE_TOWER_ITEM_BLACK_GLASSES,
		.teamFlags = 0x4A,
		.moves = {
			MOVE_HYPNOSIS,
	...
	{
		.species = SPECIES_KEDAMA, //VIGOROTH,
		.heldItem = BATTLE_TOWER_ITEM_QUICK_CLAW,
		.teamFlags = 0x04,
		.moves = {
			MOVE_SLASH,
	...
	{
		.species = SPECIES_KEDAMA, //SHEDINJA,
		.heldItem = BATTLE_TOWER_ITEM_QUICK_CLAW,
		.teamFlags = 0xCA,
		.moves = {
			MOVE_CONFUSE_RAY,
	...
	{
		.species = SPECIES_KEDAMA, //LOUDRED,
		.heldItem = BATTLE_TOWER_ITEM_PECHA_BERRY,
		.teamFlags = 0x04,
		.moves = {
			MOVE_HYPER_VOICE,
	...
	{
		.species = SPECIES_KEDAMA, //ALAKAZAM,
		.heldItem = BATTLE_TOWER_ITEM_TWISTED_SPOON,
		.teamFlags = 0x88,
		.moves = {
			MOVE_PSYCHIC,
	...
	{
		.species = SPECIES_KEDAMA, //SEAKING,
		.heldItem = BATTLE_TOWER_ITEM_MYSTIC_WATER,
		.teamFlags = 0x88,
		.moves = {
			MOVE_RAIN_DANCE,
	...
	{
		.species = SPECIES_KEDAMA, //WIGGLYTUFF,
		.heldItem = BATTLE_TOWER_ITEM_RAWST_BERRY,
		.teamFlags = 0xC3,
		.moves = {
			MOVE_SING,
	...
	{
		.species = SPECIES_KEDAMA, //AZUMARILL,
		.heldItem = BATTLE_TOWER_ITEM_CHERI_BERRY,
		.teamFlags = 0xC2,
		.moves = {
			MOVE_SURF,
	...
	{
		.species = SPECIES_KEDAMA, //PIKACHU,
	...
	{
		.species = SPECIES_KEDAMA, //DONPHAN,
		.heldItem = BATTLE_TOWER_ITEM_PERSIM_BERRY,
		.teamFlags = 0x41,
		.moves = {
			MOVE_EARTHQUAKE,
	...
	{
		.species = SPECIES_KEDAMA, //STARMIE,
		.heldItem = BATTLE_TOWER_ITEM_CHERI_BERRY,
		.teamFlags = 0xC3,
		.moves = {
			MOVE_CONFUSE_RAY,
	...
	{
		.species = SPECIES_KEDAMA, //WALREIN,
		.heldItem = BATTLE_TOWER_ITEM_NEVER_MELT_ICE,
		.teamFlags = 0x43,
		.moves = {
			MOVE_ICE_BEAM,
	...
	{
		.species = SPECIES_KEDAMA, //RELICANTH,
		.heldItem = BATTLE_TOWER_ITEM_LEFTOVERS,
		.teamFlags = 0x41,
		.moves = {
			MOVE_YAWN,
	...
	{
		.species = SPECIES_KEDAMA, //CRADILY,
		.heldItem = BATTLE_TOWER_ITEM_LEFTOVERS,
		.teamFlags = 0x43,
		.moves = {
			MOVE_CONFUSE_RAY,
	...
	{
		.species = SPECIES_KEDAMA, //ARMALDO,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x43,
		.moves = {
			MOVE_SLASH,
	...
	{
		.species = SPECIES_KEDAMA, //METAGROSS,
		.heldItem = BATTLE_TOWER_ITEM_METAL_COAT,
		.teamFlags = 0x41,
		.moves = {
			MOVE_METAL_CLAW,
	...
	{
		.species = SPECIES_KEDAMA, //EXPLOUD,
		.heldItem = BATTLE_TOWER_ITEM_LIECHI_BERRY,
		.teamFlags = 0x01,
		.moves = {
			MOVE_UPROAR,
	...
	{
		.species = SPECIES_KEDAMA, //WEEZING,
		.heldItem = BATTLE_TOWER_ITEM_SALAC_BERRY,
		.teamFlags = 0x81,
		.moves = {
			MOVE_WILL_O_WISP,
	...
	{
		.species = SPECIES_KEDAMA, //WAILORD,
		.heldItem = BATTLE_TOWER_ITEM_LEPPA_BERRY,
		.teamFlags = 0x72,
		.moves = {
			MOVE_HYDRO_PUMP,
	...
	{
		.species = SPECIES_KEDAMA, //WOBBUFFET,
		.heldItem = BATTLE_TOWER_ITEM_LEFTOVERS,
		.teamFlags = 0x20,
		.moves = {
			MOVE_ENCORE,
	...
	{
		.species = SPECIES_KEDAMA, //REGIROCK,
		.heldItem = BATTLE_TOWER_ITEM_BRIGHT_POWDER,
		.teamFlags = 0x3C,
		.moves = {
			MOVE_EARTHQUAKE,
	...
	{
		.species = SPECIES_KEDAMA, //REGISTEEL,
		.heldItem = BATTLE_TOWER_ITEM_QUICK_CLAW,
		.teamFlags = 0x3C,
		.moves = {
			MOVE_METAL_CLAW,
	...
	{
		.species = SPECIES_KEDAMA, //SLAKING,
		.heldItem = BATTLE_TOWER_ITEM_LUM_BERRY,
		.teamFlags = 0x15,
		.moves = {
			MOVE_YAWN,

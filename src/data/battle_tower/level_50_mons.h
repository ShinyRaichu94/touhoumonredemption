const struct BattleTowerPokemonTemplate gBattleTowerLevel50Mons[] =
{
	...
	{
		.species = SPECIES_KEDAMASCEPTILE,
		.heldItem = BATTLE_TOWER_ITEM_SCOPE_LENS,
		.teamFlags = 0x53,
		.moves = {
			MOVE_LEAF_BLADE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAAGGRON,
		.heldItem = BATTLE_TOWER_ITEM_MENTAL_HERB,
		.teamFlags = 0x41,
		.moves = {
			MOVE_DOUBLE_EDGE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMACRADILY,
		.heldItem = BATTLE_TOWER_ITEM_BRIGHT_POWDER,
		.teamFlags = 0xE1,
		.moves = {
			MOVE_STOCKPILE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAARMALDO,
		.heldItem = BATTLE_TOWER_ITEM_QUICK_CLAW,
		.teamFlags = 0xC1,
		.moves = {
			MOVE_EARTHQUAKE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMABRELOOM,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMALUDICOLO,
		.heldItem = BATTLE_TOWER_ITEM_PETAYA_BERRY,
		.teamFlags = 0x83,
		.moves = {
			MOVE_RAIN_DANCE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMASHIFTRY,
		.heldItem = BATTLE_TOWER_ITEM_SCOPE_LENS,
		.teamFlags = 0x03,
		.moves = {
			MOVE_TORMENT,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMATROPIUS,
		.heldItem = BATTLE_TOWER_ITEM_APICOT_BERRY,
		.teamFlags = 0xC3,
		.moves = {
			MOVE_SUNNY_DAY,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAGRUMPIG,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMATORKOAL,
		.heldItem = BATTLE_TOWER_ITEM_LUM_BERRY,
		.teamFlags = 0x81,
		.moves = {
			MOVE_IRON_DEFENSE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAMANECTRIC,
		.heldItem = BATTLE_TOWER_ITEM_NONE,
		.teamFlags = 0x03,
		.moves = {
			MOVE_THUNDERBOLT,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAPINSIR,
		.heldItem = BATTLE_TOWER_ITEM_LEPPA_BERRY,
		.teamFlags = 0x61,
		.moves = {
			MOVE_GUILLOTINE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMASTARMIE,
		.heldItem = BATTLE_TOWER_ITEM_CHESTO_BERRY,
		.teamFlags = 0x93,
		.moves = {
			MOVE_LIGHT_SCREEN,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAHERACROSS,
		.heldItem = BATTLE_TOWER_ITEM_SALAC_BERRY,
		.teamFlags = 0x51,
		.moves = {
			MOVE_MEGAHORN,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAALAKAZAM,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x13,
		.moves = {
			MOVE_PSYCHIC,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAMILOTIC,
		.heldItem = BATTLE_TOWER_ITEM_APICOT_BERRY,
		.teamFlags = 0x93,
		.moves = {
			MOVE_SURF,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAREGICE,
		.heldItem = BATTLE_TOWER_ITEM_CHESTO_BERRY,
		.teamFlags = 0x11,
		.moves = {
			MOVE_REST,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAREGISTEEL,
		.heldItem = BATTLE_TOWER_ITEM_LUM_BERRY,
		.teamFlags = 0x11,
		.moves = {
			MOVE_REST,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAREGIROCK,
		.heldItem = BATTLE_TOWER_ITEM_QUICK_CLAW,
		.teamFlags = 0x91,
		.moves = {
			MOVE_ROCK_TOMB,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMADUSCLOPS,
		.heldItem = BATTLE_TOWER_ITEM_SPELL_TAG,
		.teamFlags = 0x20,
		.moves = {
			MOVE_SHADOW_BALL,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMALANTURN,
		.heldItem = BATTLE_TOWER_ITEM_SALAC_BERRY,
		.teamFlags = 0x82,
		.moves = {
			MOVE_THUNDERBOLT,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAWEEZING,
		.heldItem = BATTLE_TOWER_ITEM_SALAC_BERRY,
		.teamFlags = 0x20,
		.moves = {
			MOVE_SLUDGE_BOMB,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAWHISCASH,
		.heldItem = BATTLE_TOWER_ITEM_PETAYA_BERRY,
		.teamFlags = 0x41,
		.moves = {
			MOVE_EARTHQUAKE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMACACTURNE,
		.heldItem = BATTLE_TOWER_ITEM_SCOPE_LENS,
		.teamFlags = 0x63,
		.moves = {
			MOVE_DYNAMIC_PUNCH,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMASHARPEDO,
		.heldItem = BATTLE_TOWER_ITEM_KINGS_ROCK,
		.teamFlags = 0x01,
		.moves = {
			MOVE_CRUNCH,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAABSOL,
		.heldItem = BATTLE_TOWER_ITEM_SALAC_BERRY,
		.teamFlags = 0x82,
		.moves = {
			MOVE_DOUBLE_EDGE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMATENTACRUEL,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x21,
		.moves = {
			MOVE_HYDRO_PUMP,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAWOBBUFFET,
		.heldItem = BATTLE_TOWER_ITEM_LEFTOVERS,
		.teamFlags = 0x23,
		.moves = {
			MOVE_ENCORE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMARHYDON,
		.heldItem = BATTLE_TOWER_ITEM_QUICK_CLAW,
		.teamFlags = 0x21,
		.moves = {
			MOVE_EARTHQUAKE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAGLALIE,
		.heldItem = BATTLE_TOWER_ITEM_SALAC_BERRY,
		.teamFlags = 0x21,
		.moves = {
			MOVE_CRUNCH,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMASCEPTILE,
		.heldItem = BATTLE_TOWER_ITEM_SCOPE_LENS,
		.teamFlags = 0x13,
		.moves = {
			MOVE_LEAF_BLADE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMABLAZIKEN,
		.heldItem = BATTLE_TOWER_ITEM_LIECHI_BERRY,
		.teamFlags = 0x17,
		.moves = {
			MOVE_BLAZE_KICK,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMASWAMPERT,
		.heldItem = BATTLE_TOWER_ITEM_SHELL_BELL,
		.teamFlags = 0x17,
		.moves = {
			MOVE_SURF,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAGARDEVOIR,
		.heldItem = BATTLE_TOWER_ITEM_SALAC_BERRY,
		.teamFlags = 0x19,
		.moves = {
			MOVE_PSYCHIC,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAHARIYAMA,
		.heldItem = BATTLE_TOWER_ITEM_SCOPE_LENS,
		.teamFlags = 0x85,
		.moves = {
			MOVE_CROSS_CHOP,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMACROBAT,
		.heldItem = BATTLE_TOWER_ITEM_BRIGHT_POWDER,
		.teamFlags = 0x49,
		.moves = {
			MOVE_ATTRACT,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAMACHAMP,
		.heldItem = BATTLE_TOWER_ITEM_SCOPE_LENS,
		.teamFlags = 0x15,
		.moves = {
			MOVE_CROSS_CHOP,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAELECTRODE,
		.heldItem = BATTLE_TOWER_ITEM_LUM_BERRY,
		.teamFlags = 0x27,
		.moves = {
			MOVE_THUNDERBOLT,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAMUK,
		.heldItem = BATTLE_TOWER_ITEM_QUICK_CLAW,
		.teamFlags = 0x05,
		.moves = {
			MOVE_SLUDGE_BOMB,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAFLYGON,
		.heldItem = BATTLE_TOWER_ITEM_PETAYA_BERRY,
		.teamFlags = 0x4D,
		.moves = {
			MOVE_DRAGON_CLAW,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMADODRIO,
		.heldItem = BATTLE_TOWER_ITEM_LIECHI_BERRY,
		.teamFlags = 0x2B,
		.moves = {
			MOVE_DRILL_PECK,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMARAICHU,
		.heldItem = BATTLE_TOWER_ITEM_FOCUS_BAND,
		.teamFlags = 0x0A,
		.moves = {
			MOVE_THUNDERBOLT,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAGOLDUCK,
		.heldItem = BATTLE_TOWER_ITEM_LIECHI_BERRY,
		.teamFlags = 0x0A,
		.moves = {
			MOVE_SURF,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAKINGDRA,
		.heldItem = BATTLE_TOWER_ITEM_CHESTO_BERRY,
		.teamFlags = 0x1D,
		.moves = {
			MOVE_SURF,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMASALAMENCE,
		.heldItem = BATTLE_TOWER_ITEM_LUM_BERRY,
		.teamFlags = 0x9C,
		.moves = {
			MOVE_DRAGON_CLAW,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAMETAGROSS,
		.heldItem = BATTLE_TOWER_ITEM_SHELL_BELL,
		.teamFlags = 0x15,
		.moves = {
			MOVE_METEOR_MASH,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMALATIAS,
		.heldItem = BATTLE_TOWER_ITEM_LUM_BERRY,
		.teamFlags = 0x96,
		.moves = {
			MOVE_MIST_BALL,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMALATIOS,
		.heldItem = BATTLE_TOWER_ITEM_APICOT_BERRY,
		.teamFlags = 0x95,
		.moves = {
			MOVE_LUSTER_PURGE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMASLAKING,
		.heldItem = BATTLE_TOWER_ITEM_CHOICE_BAND,
		.teamFlags = 0x05,
		.moves = {
			MOVE_HYPER_BEAM,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAGYARADOS,
		.heldItem = BATTLE_TOWER_ITEM_SHELL_BELL,
		.teamFlags = 0x0C,
		.moves = {
			MOVE_HYPER_BEAM,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMANINETALES,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x0A,
		.moves = {
			MOVE_CONFUSE_RAY,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAGOLEM,
		.heldItem = BATTLE_TOWER_ITEM_SALAC_BERRY,
		.teamFlags = 0x25,
		.moves = {
			MOVE_EARTHQUAKE,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMAKECLEON,
		.heldItem = BATTLE_TOWER_ITEM_CHOICE_BAND,
		.teamFlags = 0x69,
		.moves = {
			MOVE_TRICK,
	...
	{
		.species = SPECIES_KEDAMA, //KEDAMASHEDINJA,
		.heldItem = BATTLE_TOWER_ITEM_BRIGHT_POWDER,
		.teamFlags = 0xDB,
		.moves = {
			MOVE_CONFUSE_RAY,

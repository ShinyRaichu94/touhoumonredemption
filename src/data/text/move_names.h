const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] = {
    ...
    [MOVE_CUT]           = _("Cut"),
    [MOVE_GUST]          = _("Razor Wind"),
    [MOVE_WING_ATTACK]   = _("Gale"),
    ...
    [MOVE_BONEMERANG]    = _("Checkmaid"),
    [MOVE_REST]          = _("Rest"),
    [MOVE_ROCK_SLIDE]    = _("Rock Wrecker"),
    ...
    [MOVE_SLUDGE_BOMB]   = _("Gunk Shot"),
    [MOVE_MUD_SLAP]      = _("Mud Shot"),
    ...
    [MOVE_ODOR_SLEUTH]   = _("Double Team"),
    ...
    [MOVE_MUD_SHOT]      = _("Earth Power"),
    [MOVE_POISON_TAIL]   = _("Poison Jab"),
    [MOVE_COVET]         = _("Wanting"),
